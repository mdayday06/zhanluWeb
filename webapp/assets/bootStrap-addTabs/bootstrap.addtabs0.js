...
(function($) {
    ...
    $.addtabs = function(options) {
        ...
        $.addtabs.set(options);
        _listen();
       // options={"id":"baidu1","url": "https://baidu.com","target": "#tabs1","title":"百度1"};
       // $.addtabs.add(options);
    };
    ...
    $.addtabs.add = function(opts) {
        ...
        var tabid = 'tab_'+ opts.id;
        var tabpaneid = 'tabpane_'+ opts.id;
        var tab_li = a_target;
        ...
        var isexist = $.inArray(optionjson, tabs);
        if(isexist == -1 && !opts.refresh){
